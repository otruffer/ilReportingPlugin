...
class ilReportingCoursesPerUserLPReportTableGUI extends ilReportingReportTableGUI {
    ...
    /**
     * @var array Additional columns showing learning progress of objects inside course
     */
    protected $additionalColumns = array('object_title', 'object_percentage', 'object_status', 'object_type', 'object_status_changed');
    ...
    public function exportDataCustom($format, $send = false) {
        switch ($format) {
            ...
            case ilReportingGUI::EXPORT_EXCEL_FORMATTED:
                $export = new ilReportingCoursesPerUserLPExcelExport('courses_per_user_' . date('Y-m-d'));
    ...
    /**
     * Alter back link when coming from ilreportingcoursesperusergui
     */
